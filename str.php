...
<body >
<body background="hed1.jpg"  text="black" >
<h1 style="font-size:400%;font-family:algerian;color:#ffffff;" >
<div align='center'><br>QUIZ : PLACEMENT<br> </h1></div>
<br>
...
document.write("YOU SCORED  " + correct + " /8 IN PLACEMENT")
}
